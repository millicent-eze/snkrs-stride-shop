      ...
      <main className="min-h-screen bg-background pt-16">
        <section className="container mx-auto px-4 py-20">
          <div className="mb-12 text-center">
            ...
            <h1 className="font-display text-4xl font-bold text-foreground md:text-5xl">OUR KICKS</h1>
            <p className="mt-4 mx-auto max-w-md font-body text-muted-foreground">Premium sneakers for those who dare to stand out.</p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="py-20 text-center">
              <p className="font-display text-2xl text-muted-foreground">No sneakers found</p>
